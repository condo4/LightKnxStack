...
void __U_SetAddress__req(unsigned char addr_low, unsigned char addr_hight) { }
extern void U_SetAddress__req(unsigned char addr_low, unsigned char addr_hight) __attribute__ ((weak, alias ("__U_SetAddress__req")));
